...
```css
@import url('https://cdn.jsdelivr.net/gh/NastyBastrd/Midnight-Oasis@refs/heads/main/theme.css');
```
...
Midnight Oasis is a custom dark Jellyfin theme that is a fork of [KartoffelChipss NeutralFin](https://github.com/KartoffelChipss/NeutralFin/blob/main/README.md) which in turn is forked from [lscambo13's ElegantFin](https://github.com/lscambo13/ElegantFin) theme by [lscambo13](https://github.com/lscambo13), originally licensed under the [GNU General Public License v2.0](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html).

### Modifications by NastyBastrd:

- Code rewrite to make it easier to follow and amend. and personel preference.
- Theme fixes for Media Bar Enhanced.
- Fix media buttons to match theme(personel preference).
